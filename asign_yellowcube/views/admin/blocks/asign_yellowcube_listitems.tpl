...
<td valign="top" class="[{ $listclass}]" height="15"><div class="listitemfloating">    
    ...
    [{if $listitem->oxorder__oxpaymenttype->value ne "oxidpayadvance"}]
        <img src="[{$oViewConf->getModuleUrl('asign_yellowcube','out/img/parcel.png')}]" alt="" title="Order Shipped by SPS" style="vertical-align:middle;height:20px;margin-left:10px;" />
    [{/if}]
</div></td>
