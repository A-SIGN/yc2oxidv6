 ...
 * @license  http://www.a-sign.ch/
 */
namespace AsignYellowcube\Event;
...
class Asign_YellowCube_Event extends BaseModel
{
    /**
    ...
    protected static $ycSql = array(
        'actSql' => array(
            ...
            'insQuery' => array(
                ...
                "INSERT INTO `oxdeliveryset` set `OXID` = 'SPS_PRI_SI;ZF16302100', `OXSHOPID` = 1, `OXACTIVE` = 1, `OXTITLE` = 'Postpac Priority SI Abendzustellung', `OXTITLE_1` = 'Postpac Priority SI Abendzustellung', `OXTITLE_2` = 'Postpac Priority SI Abendzustellung', `OXPOS` = '103' ON DUPLICATE KEY UPDATE `OXTIMESTAMP` = CURRENT_TIMESTAMP",
                ...
                "INSERT INTO `oxdelivery` set `OXID` = 'SPS_INTECO_INTPRI', `OXSHOPID` = 1, `OXACTIVE` = 1, `OXACTIVEFROM` = '0000-00-00 00:00:00', `OXACTIVETO` = '0000-00-00 00:00:00', `OXTITLE` = 'Kleinpaket International Gewicht', `OXTITLE_1` = 'Kleinpaket International Gewicht', `OXTITLE_2` = 'Kleinpaket International Gewicht', `OXADDSUMTYPE` = 'abs', `OXADDSUM` = 0, `OXDELTYPE` = 'w', `OXPARAM` = 0, `OXPARAMEND` = 1.9, `OXFIXED` =  0, `OXSORT` = 9999, `OXFINALIZE` = 0 ON DUPLICATE KEY UPDATE `OXTIMESTAMP` = CURRENT_TIMESTAMP",
            ),
        ),
    );
