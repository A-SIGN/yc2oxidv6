...
class Asign_YellowCube_Logs extends AdminController
{
    /**
    ...
    {
        $myconfig  = oxNew(Config::class);
        $sFilepath = $myconfig->getShopConfVar("sShopDir") . "modules/asign_yellowcube/logs/YClogs.log";
