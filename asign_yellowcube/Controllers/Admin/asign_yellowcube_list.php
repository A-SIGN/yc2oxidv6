...
class Asign_Yellowcube_List extends AdminListController
{
    /**
     ...
     * @var string
     */
    protected $_sListClass = Asign_YellowCube_Model::class;
    ...
    {
        return DatabaseProvider::getDb()->getOne("select `oxshopid` from `asign_ycinventory` where `oxid` = '" . $oxid . "'");
    }
}
