 ...
 * @link     http://www.a-sign.ch/
 */
namespace AsignYellowcube\Core\Utils;
use AsignYellowcube\Core\Asign_SoapClientApi;
use AsignYellowcube\Core\Utils\Inc\WSSESoap;
use AsignYellowcube\Core\Utils\Inc\XMLSecurityKey;
    ...
    public function __doRequest($request, $location, $action, $version, $oneWay = NULL)
    {
        if (Asign_SoapClientApi::useCertificateForAllModes()) {
            try {
                ...
                Registry::getUtilsView()->addErrorToDisplay(new StandardException('[Error: __doRequest] ' . $ex->getMessage()));
            }
        }
...
//        die();
    ...
    public function __call($method, $args)
    {
        try {
            ...
            throw new StandardException($message, $e->getCode(), $e);
        }
    }
